...
>
> 🚀 **2026-07-09：新增局域网一键部署** —— 可安装在公司一台主机上作为内网服务器，其他办公电脑用浏览器访问其局域网 IP 即可，无需在各电脑安装任何东西；数据库、公司档案、证书图片、生成文件全部统一存在这台主机上。暂不开放公网。部署步骤见 [`docs/局域网部署指南.md`](docs/局域网部署指南.md)。
